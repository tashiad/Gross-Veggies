...
class MovieDetails extends Component {
  ...
  // REFACTOR THESE (put into utils file?)
        ...
        <section className="full-movie-details">
          <div className="movie-info-container">
            ...
            <div className="movie-info">
              ...
              {!currentMovie.release_date ? null : <p><span className="movie-details-label">Release Date: </span>{currentMovie.release_date}</p>}
              {!currentMovie.runtime ? null : <p><span className="movie-details-label">Runtime: </span>{currentMovie.runtime}</p>}
